...
from .views import TradeCreateView,UserTradesView,FuturesCreateView,TradeHistoryView,OptionCreateView,OptionsCreateView,ClosedTradesView,TradeCreateViews,UserLimitOrdersView
...
urlpatterns = [
    ...
    path('limit-orders/', UserLimitOrdersView.as_view(), name='limit-order'),
